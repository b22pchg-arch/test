Bản V45.29: sửa treo khi dùng nhanh bộ câu hỏi và giữ các cập nhật cấu hình liên thiết bị.
...
- PWA đã đổi cache sang V45.29.

- V45.29 sửa 3 nút Dùng tất cả bộ / Dùng bộ có nhập số câu / Bỏ chọn bộ đang dùng: không render lặp và không lưu cấu hình lặp gây treo.

- V45.29 sửa riêng checkbox tự gộp theo tỷ lệ: bật/tắt độc lập, không phát sinh vòng lặp lưu cấu hình/render gây treo.
